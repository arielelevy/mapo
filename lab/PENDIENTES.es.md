...
- [ ] **X-5e** · **la pregunta que el banco hoy no puede hacer**: ¿un modelo más potente sale **más barato en plata** para la misma calidad, porque necesita menos llamadas? Es la que el autor plantea y es empírica. Necesita `X-5a` (plata), `X-5b` (pares) y dos corridas del mismo corpus con dos modelos — y el veredicto se decide sobre **intervalo pareado**, no sobre dos puntos

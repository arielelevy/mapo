...
- [ ] **X-5r** · **capturar `reasoning_tokens`** de `completion_tokens_details`, como ya se capturó `provider_cached_tokens`. Sin eso el registro no puede separar lo que el modelo decidió gastar pensando de lo que gastó respondiendo — y en un `5.6` esa fracción no la controla nadie de este lado

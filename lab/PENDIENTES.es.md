...
- [ ] **L-4** · **rellenar el registro histórico** con `reasoning_tokens` y TTFT. El caché guarda el cuerpo completo, así que re-correr las 2.369 filas es **gratis** y no gasta un token — pero hay que hacerlo, o los campos nuevos quedan en cero para todo lo ya medido y un cero sin medir se lee igual que uno medido
